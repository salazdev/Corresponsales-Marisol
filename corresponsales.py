...
# 2. MOTOR DE CARGA "TANQUE DE GUERRA" (Prueba todas las combinaciones)
    ...
    for enc in encoding_list:
        for sep in separator_list:
            try:
                ...
                # Si el DF tiene más de 3 columnas, es que leyó bien el separador
                if len(df.columns) > 3:
...
if df is not None:
    ...
    with t2:
        ...
        # Seleccionamos solo columnas importantes para no saturar
